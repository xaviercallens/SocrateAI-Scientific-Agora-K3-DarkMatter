...
Usage:
  ...
  python3 checkers/check_U1_witness_serialization.py --all           # s7 v3,v4,v5,v5_DRAFT + s10 v4_DRAFT
...
def main():
    ...
    ap.add_argument("--all", action="store_true",
                     help="check s7 v3/v4/v5/v5-draft and s10 v4-draft certificates in one run")
    args = ap.parse_args()
