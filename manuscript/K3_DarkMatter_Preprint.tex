...
\section{Conclusion}
The tension between galactic core formation and stellar stream heating has severely challenged the ultralight axion framework. However, we have shown that FDM does not require ad-hoc "Chameleon" forces or tuned interactions if the underlying string vacuum is correctly modeled. By transitioning from approximate numerics to exact algebraic sieving and formal verification, we have demonstrated that the underlying geometric asymmetry of 4D K3 surfaces ($S_{1,2}$ and $S_{2,1}$) naturally source the precise topological mass required to resolve these tensions.
