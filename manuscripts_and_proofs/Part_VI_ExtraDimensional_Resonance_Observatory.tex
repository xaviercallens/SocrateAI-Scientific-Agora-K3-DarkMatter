...
\begin{abstract}
We explore the phenomenological consequences of identifying ultralight axion dark matter with the lowest Kaluza--Klein (KK) resonance mode of a $K3$-fibered Calabi--Yau compactification, extending the 5D orbifold dark-photon framework of Tsai, Qu, and collaborators (Sheffield, Phys.\ Rev.\ D, 2026) to an exact 6D string geometry.
...
The hypothesis that dark matter (DM) arises as a macroscopic manifestation of particles resonating through a compactified extra dimension has gained renewed theoretical interest with the proposal by Tsai, Qu, and collaborators~\cite{tsai2026} of a 5D $S^1/(Z_2 \times Z_2')$ orbifold model in which a dark photon acquires mass through Kaluza--Klein (KK) quantization.
...
Observational tool & Not specified & Projected SDSS/Euclid density map (\S\ref{sec:ws9}) \\
...
\item \textbf{$S_{2,1}$ reclassification.} The $S_{2,1}$ sequence is confirmed non-K3 (elliptic, order-2; see~\cite{callens2026partI}, Appendix~A).
A genuine K3 replacement or a principled argument for retaining $S_{2,1}$ as a ``recurrence invariant'' in the framework is needed.
...
The author thanks the Sheffield group (Tsai, Qu, and collaborators) for the theoretical inspiration provided by their extra-dimensional resonance framework, and the SDSS~DR17 collaboration for public data access.
...
\bibitem{tsai2026}
Y.-D.~Tsai, H.~Qu et al., ``Dark matter could resonate through a hidden fifth dimension,''
\textit{Phys.\ Rev.\ D} (2026); University of Sheffield press release (July 2026).
