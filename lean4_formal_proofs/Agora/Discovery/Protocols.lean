...
namespace Agora.Discovery.Protocols
...
def sigma_beta_lower_bound : Rat := 1898 / 1000
def sigma_beta_upper_bound : Rat := 1900 / 1000
def m_r_lower_bound : Rat := 451 / 1000
def m_r_upper_bound : Rat := 452 / 1000
def M_r : Rat := 1
def gamma_bound : Rat := 16063 / 8232
end Agora.Discovery.Protocols
